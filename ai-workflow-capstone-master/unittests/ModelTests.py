...
class ModelTest(unittest.TestCase):
    ...
    def test_01_train(self):
        ...
        """
        data_dir = r'C:\Users\AlexanderWhite\Documents\Python Scripts\coursera ml\ai-workflow-capstone-master\cs-train'
        ## train the model
    ...
    def test_02_load(self):
        ...
        self.assertTrue('predict' in dir(models['all']))
        self.assertTrue('fit' in dir(models['all']))
    ...
    def test_03_predict(self):
       ...
       ## ensure that a list can be passed
        ...
        result = model_predict('all','2018','08','01',test=True)
